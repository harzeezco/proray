...
const images: Image1[] = [
  {
    ...
    title: 'Phlebotomy Chairs',
    caption:
      'Ergonomically designed chairs to ensure patient comfort during blood draws.',
  },
  {
    src: '/image/image14.png',
    title: 'Hospital Beds',
    caption:
      'Adjustable and durable beds crafted to enhance patient care and comfort.',
  },
];
...
const FifthFeature: React.FC = () => {
  ...
  const windowScrollHandler = (e: WheelEvent) => {
    ...
    // Define a scroll threshold to change index
